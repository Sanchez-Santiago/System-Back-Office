export function mapDatabaseError(error, isDevelopment) {
    ...
    if (msg.includes('duplicate entry')) {
        ...
        if (msg.includes('nombre_unique'))
            simpleMessage = 'Nombre ya existe';
        if (msg.includes('usuario_unique'))
            simpleMessage = 'Usuario ya asignado';
        if (msg.includes('sap_unique'))
            simpleMessage = 'SAP ya registrado';
...
//# sourceMappingURL=databaseErrorMapper.js.map