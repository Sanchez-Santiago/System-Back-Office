...
export function correoRouter(correoModel, userModel) {
    ...
    router.get("/correos", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/correos/stats", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/correos/proximos-vencer", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/correos/vencidos", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/correos/search/sap", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/correos/search/localidad", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            ...
            logger.info(`GET /correos/search/localidad - Localidad: ${localidad}`);
    ...
    router.get("/correos/search/departamento", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            ...
            logger.info(`GET /correos/search/departamento - Departamento: ${departamento}`);
    ...
    router.get("/correos/:id", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
    ...
    router.post("/correos", authMiddleware(userModel), rolMiddleware(...ROLES_ALL), async (req, res) => {
        try {
    ...
    router.put("/correos/:id", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
    ...
    router.delete("/correos/:id", authMiddleware(userModel), rolMiddleware("SUPERADMIN"), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
...
//# sourceMappingURL=CorreoRouter.js.map