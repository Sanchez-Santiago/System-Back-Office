...
export function comentarioRouter(comentarioModel, userModel) {
    ...
    router.get("/comentarios", authMiddleware(userModel), async (req, res) => {
        try {
            ...
            const tipo_comentario = req.query.tipo_comentario;
    ...
    router.get("/comentarios/venta/:venta_id", authMiddleware(userModel), async (req, res) => {
        try {
    ...
    router.get("/comentarios/venta/:venta_id/ultimo", authMiddleware(userModel), async (req, res) => {
        try {
            const { venta_id } = req.params;
            const ventaIdNumber = Number(venta_id);
            if (isNaN(ventaIdNumber)) {
    ...
    router.get("/comentarios/usuario/:usuario_id", authMiddleware(userModel), async (req, res) => {
        try {
    ...
    router.get("/comentarios/:id", authMiddleware(userModel), async (req, res) => {
        try {
            const { id } = req.params;
    ...
    router.post("/comentarios", authMiddleware(userModel), async (req, res) => {
        try {
    ...
    router.patch("/comentarios/:id", authMiddleware(userModel), async (req, res) => {
        try {
            const { id } = req.params;
            const comentario_id = Number(id);
            const usuario_id = req.user.id;
    ...
    router.delete("/comentarios/:id", authMiddleware(userModel), async (req, res) => {
        try {
            const { id } = req.params;
            const comentario_id = Number(id);
            const usuario_id = req.user.id;
...
//# sourceMappingURL=ComentarioRouter.js.map