...
export function promocionRouter(promocionModel, userModel, pgClient) {
    ...
    router.get("/promociones", authMiddleware(userModel), async (req, res) => {
        try {
    ...
    router.get("/promociones/empresa/:empresa", authMiddleware(userModel), async (req, res) => {
        try {
    ...
    router.get("/promociones/:id", authMiddleware(userModel), async (req, res) => {
        try {
            const { id } = req.params;
    ...
    router.post("/promociones", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
    ...
    router.put("/promociones/:id", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
            const { id } = req.params;
            const body = req.body;
    ...
    router.delete("/promociones/:id", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
            const { id } = req.params;
    ...
    router.patch("/promociones/:id/activar", authMiddleware(userModel), rolMiddleware("ADMIN", "SUPERADMIN"), async (req, res) => {
        try {
            const { id } = req.params;
            const user = req.user;
            const promocion = await promocionController.getById({ id });
    ...
    router.patch("/promociones/:id/desactivar", authMiddleware(userModel), rolMiddleware("ADMIN", "SUPERADMIN"), async (req, res) => {
        try {
            const { id } = req.params;
            const user = req.user;
            const promocion = await promocionController.getById({ id });
