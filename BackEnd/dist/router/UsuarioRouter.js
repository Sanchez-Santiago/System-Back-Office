...
export function usuarioRouter(userModel) {
    ...
    router.get("/usuarios", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/usuarios/stats", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
    ...
    router.get("/usuarios/search/email", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            const email = req.query.email;
            if (!email) {
                res.status(400).json({
    ...
    router.get("/usuarios/search/legajo", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
    ...
    router.get("/usuarios/search/exa", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            const exa = req.query.exa;
            if (!exa) {
                res.status(400).json({
                    success: false,
    ...
    router.get("/usuarios/:id", authMiddleware(userModel), rolMiddleware(...ROLES_MANAGEMENT), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
    ...
    router.put("/usuarios/:id", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
    ...
    router.patch("/usuarios/:id/status", authMiddleware(userModel), rolMiddleware(...ROLES_ADMIN), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
    ...
    router.delete("/usuarios/:id", authMiddleware(userModel), rolMiddleware("SUPERADMIN"), async (req, res) => {
        try {
            const { id } = req.params;
            if (!id) {
                res.status(400).json({
