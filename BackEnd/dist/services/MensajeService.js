    ...
    async create(params) {
        try {
            ...
            if (input.tipo === "NOTIFICACION") {
                ...
                if (!["ADMIN", "BACK_OFFICE", "SUPERADMIN"].includes(usuario_creador_rol)) {
            ...
            if (validated.destinatarios) {
                ...
                if (destinatarios.length > 0) {
                    ...
                    logger.info(`${count} destinatarios agregados al mensaje ${mensaje.mensaje_id}`);
                }
            }
            return mensaje;
        }
...
//# sourceMappingURL=MensajeService.js.map