...
export class ActualizarService {
    ...
    async actualizarEstadoCorreo(estadoNew) {
        ...
        if (estadoCorreoActual) {
            ...
            else if (estadoCorreoActual.usuario_id ===
    ...
    //-------------------------------------------------------------------------------------
    // ------------------------------------------------------------------------------------
    async actualizarEstadoVenta(estadoNew) {
        if (!estadoNew) {
        ...
        if (estadoVentaActual.usuario_id ===
            "0219c4f7-a760-4365-99e2-20929b47fe99" &&
            estadoNew.usuario_id === "0219c4f7-a760-4365-99e2-20929b47fe99" &&
    ...
    async actualizarSegumientoLinea(ventaNew) {
        if (!ventaNew) {
            return 0;
        }
        if (!ventaNew.sds) {
...
//# sourceMappingURL=ActualizarService.js.map