...
export class CorreoService {
    ...
    async getAll(params) {
        try {
            ...
            throw new Error(`Error al obtener correos: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Obtener por ID (SAP)
    async getById({ id }) {
        try {
            ...
            throw new Error(`Error al obtener correo por ID: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Obtener por SAP
    async getBySAP({ sap }) {
        try {
            ...
            throw new Error(`Error al obtener correo por SAP: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Crear correo
    async create(input) {
        try {
            ...
            throw new Error(`Error al crear correo: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Actualizar correo
    async update(params) {
        try {
            ...
            throw new Error(`Error al actualizar correo: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Eliminar correo
    async delete(params) {
        try {
            ...
            throw new Error(`Error al eliminar correo: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Búsquedas especializadas
    async getByLocalidad({ localidad }) {
        try {
            ...
            throw new Error(`Error al buscar correos por localidad: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    async getByDepartamento({ departamento }) {
        try {
            ...
            throw new Error(`Error al buscar correos por departamento: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    async getProximosAVencer({ dias = 3 } = {}) {
        try {
            ...
            throw new Error(`Error al buscar correos próximos a vencer: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    async getVencidos() {
        try {
            ...
            throw new Error(`Error al buscar correos vencidos: ${error instanceof Error ? error.message : "Error desconocido"}`);
        }
    }
    // Estadísticas
    async getStats() {
...
//# sourceMappingURL=CorreoService.js.map