 ...
 */
export const UsuarioSchema = UsuarioBaseSchema.merge(PersonaSchema.pick({
    nombre: true,
    apellido: true,
    email: true,
    documento: true,
 ...
 */
export const isValidPermiso = (permiso) => {
...
export const PASSWORD_VALIDATION_MESSAGES = {
    ...
    previouslyUsed: "No puedes reutilizar una contraseña anterior. Elige una diferente.",
};
/**
 * Roles que pueden gestionar usuarios
 */
export const MANAGEMENT_ROLES = ["SUPERVISOR", "BACK_OFFICE"];
/**
 * Roles con permisos administrativos completos
 */
export const ADMIN_ROLES = ["BACK_OFFICE"];
/**
 * Todos los roles del sistema
 */
export const ALL_ROLES = ["ADMIN", "SUPERADMIN", "SUPERVISOR", "BACK_OFFICE", "VENDEDOR"];
