...
export class UsuarioController {
    ...
    async getAll(params) {
        try {
            ...
            console.log(`[INFO] Obteniendo usuarios - Página: ${page}, Límite: ${limit}`);
    ...
    async update(params) {
        try {
            ...
            console.log(`[INFO] Usuario actualizado exitosamente: ${usuarioActualizado.email}`);
    ...
    async exists(params) {
        try {
            ...
            if (resultado.exists) {
                console.log(`[INFO] Usuario existente encontrado por: ${resultado.field}`);
            }
            else {
    ...
    async changeStatus(params) {
        try {
            ...
            console.log(`[INFO] Cambiando estado de usuario ${params.id} a ${params.estado}`);
