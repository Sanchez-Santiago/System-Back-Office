...
export const UploadCorreoModal: React.FC<UploadCorreoModalProps> = ({
  isOpen,
  onClose,
  onUpload,
  isUploading = false,
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[700px] bg-white dark:bg-slate-900 rounded-[3vh] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-pink-700 p-[3vh] text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-[2vh]">
              ...
              <div>
                <h3 className="font-black uppercase tracking-widest text-[clamp(1rem,2vh,2.5rem)]">Actualizar Estado Correos</h3>
                <p className="font-bold text-purple-200 uppercase text-[clamp(0.7rem,1.2vh,1.5rem)]">Carga masiva por archivo</p>
              </div>
            </div>
            <button 
              onClick={handleClose}
        ...
        <div className="p-[3vh] space-y-[2.5vh]">
          {/* Info de columnas */}
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-[2vh] p-[2.5vh] border border-purple-100 dark:border-purple-800">
            <p className="font-black text-purple-800 dark:text-purple-300 uppercase tracking-widest mb-[1.5vh] text-[clamp(0.7rem,1.2vh,1.5rem)]">
              Columnas requeridas:
            </p>
            <div className="grid grid-cols-2 gap-[1.5vh]">
              {['Guia', 'Estado Guia', 'Ultimo Evento Nombre', 'Ubicacion'].map((col) => (
                <div key={col} className="bg-white dark:bg-slate-800 rounded-[1.5vh] p-[1.5vh] text-center border border-purple-200 dark:border-purple-700">
