  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 glass-panel p-8 rounded-[40px] border border-white/60">
        <div>
          <h2 className="text-3xl font-black tracking-tighter text-slate-900 italic uppercase">Marketplace Hub</h2>
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-1">Argumentarios & Ofertas</p>
        </div>
