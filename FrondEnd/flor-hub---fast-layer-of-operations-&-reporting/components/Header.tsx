            ...
            >
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-baseline gap-[0.4vw]">
                  <span className="font-black tracking-tighter text-slate-900 leading-none uppercase text-[clamp(1.5rem,3.5vh,4.2rem)]">FLOR</span>
                  <span className="font-black tracking-tighter text-indigo-600 leading-none uppercase text-[clamp(1.5rem,3.5vh,4.2rem)]">HUB</span>
                </div>
                <div className="flex items-center gap-[0.5vw] mt-[0.2vh]">
                  ...
                  <span className="font-black text-slate-400 tracking-[0.4em] uppercase opacity-80 text-[clamp(0.55rem,1.1vh,1.3rem)]">FAST LAYER OPS</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-[1.5vw] relative z-10">
            <div className="relative">
              <button 
                ...
                className={`relative w-[5.5vh] h-[5.5vh] flex items-center justify-center rounded-[2.2vh] transition-all border shadow-sm ${showNotifications ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white/40 text-indigo-900 border-white/60 hover:bg-indigo-50'}`}
              >
            ...
            <div className="relative">
              ...
              >
                 <div className="text-right hidden sm:block">
                   <p className={`font-black leading-none transition-colors text-[clamp(0.8rem,1.6vh,2.2rem)] ${showProfileMenu ? 'text-indigo-600' : 'text-slate-900'}`}>OPERADOR_ADMIN</p>
                   <p className="font-bold text-emerald-600 uppercase tracking-widest mt-[0.6vh] bg-emerald-100 px-[1vh] py-[0.3vh] rounded-full inline-block text-[clamp(0.6rem,1.1vh,1.3rem)]">Online</p>
                 </div>
