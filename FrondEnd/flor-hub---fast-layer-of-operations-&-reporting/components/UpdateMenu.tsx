...
export const UpdateMenu: React.FC<UpdateMenuProps> = ({ selectedCount, onUpdateStatus, onUpdateLogistic, onUpdateLine, onClear }) => {
  return (
    <div className="fixed bottom-[5vh] left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-bottom-12 duration-500 ease-out w-full max-w-[95vw] px-[2vw]">
      <div className="bg-slate-900/98 backdrop-blur-3xl border border-white/15 rounded-[4vh] p-[3.5vh] shadow-[0_5vh_10vh_-2vh_rgba(0,0,0,0.6)] flex items-center justify-between gap-[3vh] overflow-x-auto lg:overflow-visible no-scrollbar">
        ...
        <div className="flex items-center gap-[2vh] pr-[3vh] border-r border-white/10 shrink-0">
          <div className="relative">
            ...
            <div className="absolute -top-[0.5vh] -right-[0.5vh] w-[1.5vh] h-[1.5vh] bg-emerald-500 rounded-full border-2 border-slate-900 animate-pulse"></div>
          </div>
          <div>
            <p className="font-black text-indigo-300 uppercase tracking-[0.2em] leading-none text-[clamp(0.6rem,1.1vh,0.9rem)]">Ventas</p>
            <p className="font-black text-white uppercase tracking-widest mt-[0.5vh] text-[clamp(0.6rem,1.1vh,0.9rem)]">Seleccionadas</p>
            <button onClick={onClear} className="font-bold text-slate-400 hover:text-indigo-300 uppercase mt-[1vh] transition-colors flex items-center gap-[0.5vh] text-[clamp(0.5rem,0.9vh,0.75rem)]">
        ...
        <div className="flex flex-1 items-center gap-[3vh] justify-center">
          ...
          <div className="flex flex-col gap-[1vh] min-w-[18vw]">
            ...
            <div className="relative group">
              <select 
                className="w-full h-[6.5vh] bg-white/5 border border-white/10 rounded-[1.8vh] px-[1.5vw] font-black text-white outline-none cursor-pointer hover:bg-white/10 hover:border-indigo-500 transition-all uppercase appearance-none text-[clamp(0.8rem,1.3vh,1.1rem)]"
              ...
              <div className="absolute right-[1vw] top-1/2 -translate-y-1/2 pointer-events-none text-white/40">
          ...
          <div className="flex flex-col gap-[1vh] min-w-[18vw]">
            ...
            <div className="relative">
              <select 
                className="w-full h-[6.5vh] bg-indigo-500/5 border border-indigo-500/20 rounded-[1.8vh] px-[1.5vw] font-black text-white outline-none cursor-pointer hover:bg-indigo-500/10 hover:border-indigo-400 transition-all uppercase appearance-none text-[clamp(0.8rem,1.3vh,1.1rem)]"
          ...
          <div className="flex flex-col gap-[1vh] min-w-[18vw]">
            ...
            <div className="relative">
              <select 
                className="w-full h-[6.5vh] bg-purple-500/5 border border-purple-500/20 rounded-[1.8vh] px-[1.5vw] font-black text-white outline-none cursor-pointer hover:bg-purple-500/10 hover:border-purple-400 transition-all uppercase appearance-none text-[clamp(0.8rem,1.3vh,1.1rem)]"
        ...
        <div className="pl-[3vh] border-l border-white/10 shrink-0">
