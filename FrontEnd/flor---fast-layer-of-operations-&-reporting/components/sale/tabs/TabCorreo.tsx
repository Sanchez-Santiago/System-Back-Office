...
import { useTabCorreoViewModel } from '../../../viewmodels/sale/useTabCorreoViewModel';
...
export const TabCorreo = memo(({ editedData, isEditing, onEdit, onUpdateLogistic }: { 
  ...
  const { state, actions } = useTabCorreoViewModel({ onUpdateLogistic });
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex items-center justify-between">
        ...
        {!state.showLogisticForm && (
          <button 
            onClick={() => actions.setShowLogisticForm(true)}
